...
//
// It receives a connections from the conns channel and handles them with help
// of the delegate. Also it implements the jointwork.Task, so it +
// ConnReceiver may do the job together.
//
